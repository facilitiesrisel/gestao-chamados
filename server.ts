...
async function startServer() {
  ...
  app.post("/api/maintenance-items/sync", authenticateToken, async (req, res) => {
    try {
  ...
  app.post("/api/operational-bases/sync", authenticateToken, async (req, res) => {
    try {
  ...
  app.post("/api/urgency-configs/sync", authenticateToken, async (req, res) => {
    try {
